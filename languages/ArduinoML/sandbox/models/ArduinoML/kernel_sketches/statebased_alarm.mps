...
<model ref="r:662a67f5-2045-411d-ac66-27f4fb9b9eee(ArduinoML.kernel_sketches.statebased_alarm)">
  ...
  <node concept="B5LkZ" id="3e1pPA_M1bY">
    <property role="TrG5h" value="StateBasedAlarm" />
    <ref role="B25EO" node="3e1pPA_M1c0" resolve="off" />
    <node concept="B5LkS" id="3e1pPA_M1c1" role="B5Lb9">
      <property role="TrG5h" value="led" />
      <property role="B5KAR" value="12" />
    </node>
    <node concept="B5LkT" id="3e1pPA_M1c7" role="B5Lb9">
      <property role="TrG5h" value="button" />
      <property role="B5KAR" value="9" />
    </node>
    <node concept="B25XI" id="3e1pPA_M1c0" role="B25FG">
      <property role="TrG5h" value="off" />
      <node concept="B25Yp" id="3e1pPA_M1ch" role="B25WF">
        <property role="B25X1" value="false" />
        <ref role="B25Xg" node="3e1pPA_M1c1" resolve="led" />
      </node>
      <node concept="B25N_" id="3e1pPA_MaXK" role="B25WY">
        <property role="B25Mk" value="true" />
        <ref role="B25ME" node="3e1pPA_M1c7" resolve="button" />
        <ref role="B25MG" node="3e1pPA_M1cp" resolve="on" />
        <node concept="B5LkT" id="3e1pPA_MaXL" role="2minm6" />
      </node>
    </node>
    <node concept="B25XI" id="3e1pPA_M1cp" role="B25FG">
      <property role="TrG5h" value="on" />
      <node concept="B25Yp" id="3e1pPA_M1cw" role="B25WF">
        <property role="B25X1" value="true" />
        <ref role="B25Xg" node="3e1pPA_M1c1" resolve="led" />
      </node>
      <node concept="B25N_" id="3e1pPA_MaXR" role="B25WY">
        <property role="B25Mk" value="true" />
        <ref role="B25ME" node="3e1pPA_M1c7" resolve="button" />
        <ref role="B25MG" node="3e1pPA_M1c0" resolve="off" />
        <node concept="B5LkT" id="3e1pPA_MaXS" role="2minm6" />
      </node>
    </node>
  </node>
</model>
